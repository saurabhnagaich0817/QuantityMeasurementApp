...
using QuantityMeasurement.Model.Core.Exceptions;
using QuantityMeasurement.Model.Quantities;
using QuantityMeasurement.Model.Units;

namespace QuantityMeasurement.Tests.DomainTests.GenericQuantityTests
{
    /// <summary>
